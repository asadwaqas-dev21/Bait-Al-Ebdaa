...
export const serviceContent = {
  ...
  joinery: {
    ...
    ar: {
      ...
      faqs: [
        { q: "هل تُصنَّع النجارة خارج الموقع أم في الموقع؟", a: "تُصنَّع في منشأتنا الخاصة البالغة 15,000 قدم مربع في مجمع دبي للاستثمار باستخدام مكونات مقطوعة بالحاسوب وتشطيب مضبوط في المصنع، ثم تُوصَّل وتُركَّب في الموقع بواسطة فريق التركيب الخاص بنا. هذا يمنح دقة أعلى وحواف أكثر استقامة وتشطيباً أكثر ثباتاً من النجارة المنفذة في الموقع، حيث يجعل الغبار والرطوبة ومساحة العمل المحدودة تحقيق هذا المستوى من الدقة أصعب بكثير." },
